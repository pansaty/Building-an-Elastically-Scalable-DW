...
$DLAnalyticsDoP = 2
$SourceFolder = "/DataFiles/NYTaxi/Raw/TaxiData/green/" 
$DestFolder = "/DataFiles/NYTaxi/Prepared/TaxiData/green/" 
...
ForEach ($year in $Years)
{
    if ($year.name -lt 2015)
    {
        ...
        ForEach ($file in $files)
        {
            ...
            $USQLProcCall = '[NYCTaxi].[dbo].[GreenTrip_Pre2015]("' + $InputPath + '","' + $OutputPath + '" );'
    ...
    elseif ($year.Name -eq 2015)
    {
        ...
        ForEach ($file in $files)
        {
            ...
            {
                $USQLProcCall = '[NYCTaxi].[dbo].[GreenTrip_2015H1]("' + $InputPath + '","' + $OutputPath + '" );'
                $JobName = 'Output daily avg dataset for ' + $file.name         
                Write-Host $USQLProcCall
            ...
            {
                $USQLProcCall = '[NYCTaxi].[dbo].[GreenTrip_2015H2_2016H1]("' + $InputPath + '","' + $OutputPath + '" );'
                $JobName = 'Output daily avg dataset for ' + $file.name         
                Write-Host $USQLProcCall
    ...
    elseif ($year.Name -eq 2016)
    {
        ...
        ForEach ($file in $files)
        {
            ...
            {
                $USQLProcCall = '[NYCTaxi].[dbo].[GreenTrip_2016H2]("' + $InputPath + '","' + $OutputPath + '" );'
                $JobName = 'Output daily avg dataset for ' + $file.name         
                Write-Host $USQLProcCall
    ...
    elseif ($year.Name -eq 2017)
    {
        ...
        ForEach ($file in $files)
        {
            ...
            $USQLProcCall = '[NYCTaxi].[dbo].[GreenTrip_2017]("' + $InputPath + '","' + $OutputPath + '" );'
            $JobName = 'Output daily avg dataset for ' + $file.name         
            Write-Host $USQLProcCall
